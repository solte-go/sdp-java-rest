...
* The original package name 'pro.soltedev.graphql-posts.soltedev graphql api' is invalid and this project uses 'pro.soltedev.graphqlposts.soltedev.graphql.api' instead.
